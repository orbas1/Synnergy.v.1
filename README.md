...
- **Stage 73 enterprise CLI alignment** – `syn3700`, `syn3800`, `syn3900` and `syn500` commands now require wallet authentication, emit JSON telemetry for the function web UI and persist auditable events covering releases, approvals and utility usage limits.
