...
func main() {
	...
	register("resilience", "Stage 77 high-availability workflows", "Stage77FailoverInit", "Stage77FailoverRegister", "Stage77FailoverHeartbeat", "Stage77FailoverActive", "Stage77FailoverReport")
