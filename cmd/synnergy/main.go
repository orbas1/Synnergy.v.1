...
func main() {
	...
	// Stage 67 Kademlia operations
        ...
        // Stage 74 enterprise token services
        mustRegister("SYN500Create")
        mustRegister("GrantServiceTier")
        mustRegister("RevokeServiceTier")
        mustRegister("RecordServiceUsage")
        mustRegister("SYN500Snapshot")
        mustRegister("SYN500Audit")
        mustRegister("RegisterIPAsset")
        mustRegister("TransferIPAsset")
        mustRegister("CreateIPLicense")
        mustRegister("RecordIPRoyalty")
        mustRegister("DescribeIPAsset")
        mustRegister("ListIPAssets")
        mustRegister("SummariseIPRoyalties")
        mustRegister("RegisterTangibleAsset")
        mustRegister("UpdateAssetValuation")
        mustRegister("AssignAssetCustodian")
        mustRegister("DescribeTangibleAsset")
        mustRegister("AssetSnapshot")
        mustRegister("AssetHistory")
